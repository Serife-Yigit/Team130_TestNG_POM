...
public class C02_PageClassKullanimi {
    ...
    public void aramaTesti(){
        ...
        int actualSonucSayisi = testOtomasyonPage.bulunanUrunElementlerListesi.size();
        int expectedMinSonucSayisi = 3;

        Assert.assertTrue(actualSonucSayisi>expectedMinSonucSayisi);

        //4- ilk urunu tiklayin
        testOtomasyonPage.bulunanUrunElementlerListesi.get(0).click();
        ...
        String actualUrunIsmiKucukHarf = testOtomasyonPage
                .urunSayfasindaUrunIsimElenmenti
                .getText()
                .toLowerCase();
